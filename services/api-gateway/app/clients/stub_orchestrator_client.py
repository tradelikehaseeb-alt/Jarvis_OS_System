...
Mirrors orchestrator create → capability route → agent → skill flow with static payloads.
...
class StubOrchestratorClient:
    ...
    Responses align with LocalBridgeOrchestratorClient / orchestrator output shape.
    """
